                ...
                FadeInAnimation(
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      // Tentukan ukuran gambar berdasarkan lebar layar
                      double imageSize;
                      if (screenWidth > 600) {
                        // Jika layar lebih lebar (tablet), gambar lebih besar
                        imageSize = screenWidth * 0.2; // Gambar 30% dari lebar layar
                      } else {
                        // Jika layar lebih kecil (handphone), gambar lebih kecil
                        imageSize = screenWidth * 0.3; // Gambar 50% dari lebar layar
                      }
